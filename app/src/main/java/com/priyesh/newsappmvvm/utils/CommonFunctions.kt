...
object CommonFunctions {
    ...
    fun convertISOToRequiredFormat(isoDate: String?, requiredFormat: String = "MMM dd, yyyy HH:mm"): String? {
    ...
    fun timeMillisToRequiredFormat(timeInMillis: Long, requiredFormat: String = EEEE_MMM_dd_yyyy): String {
    ...
    fun createSingleViewAdapter(view: View): RecyclerView.Adapter<RecyclerView.ViewHolder> {
        return object : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) { /*Not in use*/ }
